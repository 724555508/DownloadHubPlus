...
一款轻量级的 Android 浏览器应用，集成了强大的下载管理和视频播放功能。

## 📱 主要功能

### 🌐 浏览器核心
- **快速浏览**：基于 WebView 的轻量级浏览器内核
- **多标签管理**：支持多标签页同时浏览
- **隐私模式**：无痕浏览，保护您的隐私
- **自定义搜索引擎**：支持 DuckDuckGo、Google、Bing 等搜索引擎
...
如果您在使用过程中遇到任何问题或有功能建议，欢迎通过 GitHub Issues 反馈。
